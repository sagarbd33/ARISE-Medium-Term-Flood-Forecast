...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.20346162.svg)](https://doi.org/10.5281/zenodo.20346162)
...
This repository hosts the source code, installer build files, and supporting documentation for the **NWP-Driven Medium-Term Sub-System**, packaged as the desktop application *ARISE - Medium Term Flood Forecast (v2.1.0)*.
...
Trained models and HEC-HMS project files are bundled in the pre-built Windows installer hosted on Zenodo: **https://doi.org/10.5281/zenodo.20346162** (v2.1.0). For source-only researchers, please write to the corresponding author.
...
> Debbarma, S. (2026). *ARISE - Medium Term Flood Forecast Installer (v2.1.0)* (Version 2.1.0) [Software]. Zenodo. https://doi.org/10.5281/zenodo.20346162
