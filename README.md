...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.20357890.svg)](https://doi.org/10.5281/zenodo.20357890)
...
1. Download **`ARISE - Medium Term Flood Forecast Installer.exe`** (≈ 2 GB) from the Zenodo archive: **https://doi.org/10.5281/zenodo.20357890** (v2.1.1).
...
Trained models and HEC-HMS project files are bundled in the pre-built Windows installer hosted on Zenodo: **https://doi.org/10.5281/zenodo.20357890** (v2.1.1). For source-only researchers, please write to the corresponding author.
...
> Debbarma, S. (2026). *ARISE - Medium Term Flood Forecast Installer (v2.1.1)* (Version 2.1.1) [Software]. Zenodo. https://doi.org/10.5281/zenodo.20357890
